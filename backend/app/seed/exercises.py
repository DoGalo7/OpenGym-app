...
EXERCISES = [
    ...
    {"name": "Inchworm", "muscle_group": "volledig_lichaam", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "High Knees", "muscle_group": "volledig_lichaam", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "World's Greatest Stretch", "muscle_group": "volledig_lichaam", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Butt Kickers", "muscle_group": "benen", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Leg Swings", "muscle_group": "benen", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Cat-Cow Stretch", "muscle_group": "rug", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Band Pull-Apart", "muscle_group": "schouders", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Banded Row", "muscle_group": "rug", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Hip Circles", "muscle_group": "billen", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Torso Twists", "muscle_group": "buik", "level": "beginner", "category": "bodyweight", "requires_gym": False},
    {"name": "Arm Swings", "muscle_group": "armen", "level": "beginner", "category": "bodyweight", "requires_gym": False},
