...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Extra filters: 🏠 Ook thuis, 🔥 Hyrox-stijl, 🤝 Buddy WOD, 💪 Power (kracht-gerichte, vaak kortere workouts per spiergroep) - allemaal los aan/uit te zetten, bovenop de categorie.",
